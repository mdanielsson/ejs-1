...
#define EC_FLAGS_RUN             0x40                   /* Code generated will be run immediately */
#define EC_FLAGS_THROW           0x80                   /* Throw errors when compiling. Used for eval() */
...
extern int          ecInitCompiler(EjsService *service);
