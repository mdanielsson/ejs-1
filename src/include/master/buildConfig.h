 ...
 */ 
    ...
    #define BLD_COMPONENTS "winsdk ar cc make nm ld mt rc doxygen pkg regexp mpr sqlite apache appweb ejs"
    ...
    #define BLD_INC_PREFIX "/Program Files/Embedthis Ejscript/include/ejs"
    ...
    #define BLD_SRC_PREFIX "/Program Files/Embedthis Ejscript/ejs-1.0.0"
    #define BLD_WEB_PREFIX "/Program Files/Embedthis Ejscript/web"

    #define BLD_BIN_NAME "bin"
    #define BLD_LIB_NAME "bin/i686-pc-win"
    #define BLD_OBJ_NAME "obj"
    #define BLD_MOD_NAME "bin/i686-pc-win"
    ...
    #define BLD_EJS_LIBS "ejs mpr pcre"
    #define BLD_EJS_OPTIONAL_DEPENDENCIES "ssl"
    #define BLD_EJS_WITH "1"
    #define BLD_EJS_WITHLIBS "mpr pcre"
