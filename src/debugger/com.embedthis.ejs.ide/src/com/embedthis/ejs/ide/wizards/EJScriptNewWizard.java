...
public class EJScriptNewWizard extends Wizard implements INewWizard, 
						IWorkbenchWindowActionDelegate {
	private EJScriptNewWizardPage page;
	private ISelection selection;
	private IWorkbenchWindow window;
	
	/**
	 * Constructor for EJScriptNewWizard.
	 */
	public EJScriptNewWizard() {
		super();
	...
	public void addPages() {
		page = new EJScriptNewWizardPage(selection);
		addPage(page);
	}
	...
	public void run(IAction action) {
		Wizard wizard = new EJScriptNewWizard();
