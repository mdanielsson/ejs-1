...
/**
 * This class contains the results of comparing two PakDefFiles together.
 * 
 * The usage is 
 * PakDefFileDifference diff = newPakDefFile.compare(oldPakDefFile);
 * @author Gavin
 *
 */
public class PakDefFileDifference {
